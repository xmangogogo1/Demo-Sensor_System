package soSafeSystem.components;
...
public class FireSensor extends Sensor {
    ...
    public void raiseAlarm(List<SoSafe.Alarm> alarmList, List<SoSafe.Alarm> alarmRecordList, SoSafe soSafe){
        //if fire sensor soSafeSystem is on or if user set sensor working schedule
        ...
        } else {// do nothing if soSafeSystem is not turn on or sensor is not scheduled
            return;
        }
    }
